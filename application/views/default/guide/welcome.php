...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('public/scss/main.css'); ?>" type="text/css" media="all">
...
<body>
    <?php $this->load->view('default/guide/_header'); ?>
    <?php if (!empty($main)) echo $main; ?>
    <?php $this->load->view('default/guide/_footer'); ?>
