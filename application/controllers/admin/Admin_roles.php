...
class Admin_roles extends ADMIN_Controller
{
	...
	function index(){
		...
		$this->view('admin/admin_roles/index', $data);
	}
	...
	function add(){
		...
		$this->view('admin/admin_roles/add', $data);
	}
	...
	function edit($id=""){
		...
		$this->view('admin/admin_roles/edit', $data);
	}
	...
	function access($id=""){
		...
		$this->view('admin/admin_roles/access', $data);
	}
	...
	public function module(){
		...
		$this->view('admin/admin_roles/module_list', $data);
	}
	...
	public function module_add(){
		...
		if($this->input->post('submit')){
			...
			$this->view('admin/admin_roles/module_add', $data);
		}
	}
	...
	public function module_edit($id=0){
		...
		if($this->input->post('submit')){
			...
			$this->view('admin/admin_roles/module_edit', $data);
		}
	}
	...
	public function sub_module($module_id = NULL){
		...
		$this->view('admin/admin_roles/sub_module_list', $data);
	}
	...
	public function sub_module_add(){
		...
		if($this->input->post('submit')){
			...
			$data['title'] = '';
			$this->view('admin/admin_roles/sub_module_add', $data);
		}
	}
	...
	public function sub_module_edit($id = 0){
		...
		if($this->input->post('submit')){
			...
			$this->view('admin/admin_roles/sub_module_edit', $data);
		}
	}
